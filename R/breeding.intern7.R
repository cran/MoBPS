...
#' @export
#'
breeding.intern7 <- function(info.parent, parent,  population , mutation.rate = 10^-5, remutation.rate = 10^-5, recombination.rate=1,
  ...
  return(list(new.poc, new.mut, new.origin, info.parent, new.dup, porc, share_a, porc_temp))
}
