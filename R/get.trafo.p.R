...
#' @return Parameter input used in the transformation function
#' @export

get.trafo.p <- function(population, database=NULL, gen=NULL, cohorts=NULL, id = NULL, use.id=TRUE, include = NULL){
